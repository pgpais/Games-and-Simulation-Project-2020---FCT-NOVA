...
namespace Bolt
{
    ...
    public static class BoltDynamicData
    {
        ...
        {
            List<STuple<BoltGlobalBehaviourAttribute, Type>> result =
                new List<STuple<BoltGlobalBehaviourAttribute, Type>>();
            ...
            try
            {
                ...
                while (asmIter.MoveNext())
                {
                    ...
                    foreach (Type type in asm.GetTypes())
                    {
                        ...
                        {
                            var attrs = (BoltGlobalBehaviourAttribute[]) type.GetCustomAttributes(
                                typeof(BoltGlobalBehaviourAttribute), false);
