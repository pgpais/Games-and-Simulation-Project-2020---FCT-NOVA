...
public partial class BoltWizardWindow
{
    ...
    class BoltWizardText
    {
        ...
        internal static readonly string SUPPORT =
            "You can contact the Bolt Team or Photon Services using one of the following links. You can also go to Bolt Documentation in order to get started with Photon Bolt.";

        internal static readonly string PACKAGES =
            "Here you will be able to select all packages you want to use into your project. Packages marked green are already installed. \nClick to install.";

        internal static readonly string PHOTON =
            "In this step, you will configure your Photon Cloud credentials in order to use our servers for matchmaking, relay and much more. Please fill all fields with your desired configuration.";
        ...
        internal static readonly string FINISH_QUESTION =
            "In order to finish the setup, Bolt needs to compile all Assets, do you want to proceed? If you opt to not compile now, you can run it on \"Bolt/Compile Assembly\".";
...
#pragma warning restore RECS0026 // Possible unassigned object created by 'new'
    ...
    {
        var text = (TextAsset) AssetDatabase.LoadAssetAtPath(
            Path.Combine(BoltPathUtility.BasePath, "release_history.txt"), typeof(TextAsset));
