...
namespace Photon.Realtime
{
...
#if UNITY_WEBGL
            SocketWebTcp.SerializationProtocol =
 Enum.GetName(typeof(SerializationProtocol), this.LoadBalancingPeer.SerializationProtocolType);
#endif
 ...
 Enum.GetName(typeof(SerializationProtocol), this.LoadBalancingPeer.SerializationProtocolType);
        ...
        private bool CallAuthenticate()
        {
            ...
            else
            {
                ...
                return this.LoadBalancingPeer.OpAuthenticateOnce(this.AppId, this.AppVersion, this.AuthValues,
                    this.CloudRegion, this.EncryptionMode, this.ExpectedProtocol);
            }
        }
        ...
        /// <summary>Internally used to cache and set properties (including well known properties).</summary>
        /// <remarks>Requires being in a room (because this attempts to send an operation which will fail otherwise).</remarks>
        public bool OpSetPropertiesOfRoom(Hashtable gameProperties, Hashtable expectedProperties = null,
            WebFlags webFlags = null)
        {
            if (!this.CheckIfOpCanBeSent(OperationCode.SetProperties, this.Server, "SetProperties"))
            {
        ...
        public virtual void OnOperationResponse(OperationResponse operationResponse)
        {
            ...
            switch (operationResponse.OperationCode)
            {
                ...
                case OperationCode.AuthenticateOnce:
                {
                    if (operationResponse.ReturnCode != 0)
                    {
                        ...
                        switch (operationResponse.ReturnCode)
                        {
                            ...
                            case ErrorCode.AuthenticationTicketExpired:
                                ...
                                this.ConnectionCallbackTargets.OnDisconnected(DisconnectCause
                                    .AuthenticationTicketExpired);
                                break;
                        }
                    ...
                    if (this.Server == ServerConnection.NameServer)
                    {
                        ...
                        if (this.AuthMode == AuthModeOption.AuthOnceWss)
                        {
                            this.DebugReturn(DebugLevel.INFO,
                                string.Format(
                                    "Due to AuthOnceWss, switching TransportProtocol to ExpectedProtocol: {0}.",
                ...
                case OperationCode.GetRegions:
                    ...
                    {
                        this.DebugReturn(DebugLevel.ERROR,
                            "GetRegions failed. Can't provide regions list. Error: " + operationResponse.ReturnCode +
                            ": " + operationResponse.DebugMessage);
                        break;
                    }
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            ...
            switch (photonEvent.Code)
            {
                ...
                case EventCode.Leave:
                    ...
                    this.InRoomCallbackTargets
                        .OnPlayerLeftRoom(
                            originatingPlayer); // TODO: make sure it's clear how to separate "inactive"- from "abandon"-leave, as well as kicked out
                    break;
        ...
        public bool OpWebRpc(string uriPath, object parameters, bool sendAuthCookie = false)
        {
            ...
            {
                this.DebugReturn(DebugLevel.ERROR,
                    string.Format("Operation {0} ({1}) not allowed on current server ({2})", "WebRPC",
                        OperationCode.WebRpc, this.Server));
                return false;
            }
